...
from Queen import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3, ASS_CLI_4, ASS_CLI_5,
                   ...
                   OWNER_ID, app)
from Queen.Core.Clients.cli import LOG_CLIENT
from Queen.Core.PyTgCalls.Queen import (pytgcalls1, pytgcalls2, pytgcalls3,
                                        pytgcalls4, pytgcalls5)
from Queen.Database import (get_active_chats, get_active_video_chats,
                            get_sudoers, is_on_off, remove_active_chat,
                            remove_active_video_chat)
from Queen.Inline import private_panel
from Queen.Plugins import ALL_MODULES
from Queen.Utilities.inline import paginate_modules
...
@app.on_message(filters.command("Queen") & filters.private)
