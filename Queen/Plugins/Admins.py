...
from Queen.Core.PyTgCalls.Queen import (pause_stream, resume_stream,
                                        skip_stream, skip_video_stream,
                                        stop_stream)
from Queen.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat,
                            remove_active_video_chat)
from Queen.Decorators.admins import AdminRightsCheck
from Queen.Decorators.checker import checker, checkerCB
from Queen.Inline import audio_markup, primary_markup, secondary_markup2
